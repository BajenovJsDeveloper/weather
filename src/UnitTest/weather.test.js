...
describe('Testing wether method .getSize()', () => {
  ...
  test('will return size of array  25', () => {
    expect(Weather.getSize()).toBe(23);
  });
});
...
//     expect(Weather.getMinMaxTemp()).toContain(1);
//     expect(Weather.getMinMaxTemp()).toContain(10);
//     expect(Weather.getMinMaxTemp()).not.toContain(null);
//   });
// });
